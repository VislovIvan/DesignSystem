...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/VislovIvan/DesignSystem'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'VislovIvan' => 'vislov.ivan@bk.ru' }
  s.source           = { :git => 'https://github.com/VislovIvan/DesignSystem.git', :tag => s.version.to_s }
